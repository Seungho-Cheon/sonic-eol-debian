...
# stub: ruby/ext/google/protobuf_c/extconf.rb
...
Gem::Specification.new do |s|
  ...
  s.extensions = ["ruby/ext/google/protobuf_c/extconf.rb".freeze]
  s.files = ["ruby/ext/google/protobuf_c/extconf.rb".freeze]
